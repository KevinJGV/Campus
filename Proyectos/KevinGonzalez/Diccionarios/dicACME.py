    ...
    while True:
        try:
            ...
            if n < 8000 or n > 150000:
                print(
                    "Valor de la Hora inválida. Debe estar en el rango de [8000, 150000]")
                continue
            return n
        except ValueError:
...
def modificarEmpleado(dicEmpleados):
    ...
    dicEmpleados[idEmpl]["Salario"] = dicEmpleados[idEmpl]["ValorHora"] * \
        dicEmpleados[idEmpl]["HorasTrabajadas"]
